...
module.exports = function (/* ctx */) {
  return {
    ...
    build: {
      ...
      devtool: 'source-map', // this is a configuration passed on to the underlying Webpack
      // transpile: false,
    ...
    framework: {
      ...
      // Quasar plugins
      plugins: ['Dialog', 'Loading', 'LocalStorage', 'SessionStorage']
    },
